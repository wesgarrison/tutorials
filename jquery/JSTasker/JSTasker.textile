...
# Create a new variable and store into it the string of "<li>" plus the name of the task plus "</li>"
...
We need to make the @update_task_counter@ actually do its thing.  Here's how it'll work:
...
h2. I5: Click to Reorder

Our task list is really starting to work, but we should be able to reorder the tasks.