...
You should now be redirected to @http://localhost:3000/orders/1@ which is your current order.  You're looking at the order, you think some products have been added, but we're not doing anything to display them yet.  Let's improve this view.

Open your @/app/views/orders/show.html.erb@ file and let's rewrite it like this:
